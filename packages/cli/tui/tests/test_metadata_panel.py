...
async def test_metadata_panel_set_from_record(make_search_record):
...
async def test_metadata_panel_no_date(make_search_record):
    async with MetadataPanelApp().run_test() as pilot:
        panel = pilot.app.query_one(MetadataPanel)
...
async def test_metadata_panel_provenance(make_search_record):
    async with MetadataPanelApp().run_test() as pilot:
        panel = pilot.app.query_one(MetadataPanel)
        record = make_search_record(
...
async def test_metadata_panel_institution(make_search_record):
    async with MetadataPanelApp().run_test() as pilot:
        panel = pilot.app.query_one(MetadataPanel)
        record = make_search_record(
...
async def test_metadata_panel_no_reference_code(make_search_record):
    async with MetadataPanelApp().run_test() as pilot:
        panel = pilot.app.query_one(MetadataPanel)
...
async def test_metadata_panel_enrich_from_oai(make_search_record):
    async with MetadataPanelApp().run_test() as pilot:
        panel = pilot.app.query_one(MetadataPanel)
        record = make_search_record()
        panel.set_from_record(record)
...
async def test_metadata_panel_enrich_from_oai_empty(make_search_record):
...
async def test_metadata_panel_enrich_truncates_description(make_search_record):
    async with MetadataPanelApp().run_test() as pilot:
        panel = pilot.app.query_one(MetadataPanel)
        record = make_search_record()
        panel.set_from_record(record)
