"""
MCP resources for Riksarkivet historical guide documents.

Provides access to table of contents and guide sections as MCP resources.
"""
...
def register_guide_resources(mcp) -> None:
    """Register guide resources with the MCP server."""

    @mcp.resource("riksarkivet://contents/table_of_contents")
    ...
    @mcp.resource("riksarkivet://guide/{filename}")
